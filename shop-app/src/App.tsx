...
// Discord's embedded webview can start before storage is available (or deny
// it for a fresh Activity origin). Never let that browser exception blank the
// whole React app.
...
function safeStorageSet(key: string, value: string): void {
  try {
    ...
    // The Activity can still use its in-memory session.
  }
}
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const setupActivity = async () => {
      ...
      try {
        // Always prefer the bot/server's configured OAuth client ID. This prevents
        // the Activity from hanging when an old hard-coded client ID remains in
        // the frontend bundle after the Discord application was changed.
