...
const demoProducts: Product[] = [
  ...
  { id: "rob", name: "FR | rob", category: "Roller", price: 5000, icon: "crown-purple", description: "FR Family sunucusunda satın alınabilir rol." },
...
export default function App() {
  ...
  const loadCatalog = async (token: string) => {
    ...
    const missingRoles = demoProducts.filter((item) =>
      ["ayyildizi", "elite", "robux-manyagi", "rob", "vip"].includes(item.id) &&
